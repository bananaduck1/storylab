        ...
        <div className="ml-auto flex items-center gap-4">
          <nav aria-label="Primary" className="hidden items-center gap-6 md:flex">
            ...
            <div className="group relative">
              ...
              <div
                role="menu"
                className="invisible absolute right-0 top-full z-20 mt-3 min-w-[220px] rounded-2xl border border-zinc-200 bg-white p-2 shadow-lg opacity-0 transition group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100"
              >
                {academyLinks.map((l) => (
                  <Link
                    key={l.href}
