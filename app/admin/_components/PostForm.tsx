...
export function PostForm({ post }: { post?: PostEditorData }) {
    ...
    <div className="flex flex-col h-dvh bg-white">
      ...
      <div className="flex-none flex items-center justify-between border-b border-zinc-200 px-4 py-3 bg-white">
        ...
        <div className="flex items-center gap-3">
          ...
          {error && (
            <span className="text-xs text-red-600 max-w-48 truncate">{error}</span>
          )}
        ...
        >
          <div className="max-w-xl mx-auto px-8 py-10">
            <div className="mb-8 pb-8 border-b border-zinc-200">
              ...
              {excerpt && (
                <p className="text-lg text-zinc-600 leading-relaxed">{excerpt}</p>
              )}
              {published && (
