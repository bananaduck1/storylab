...
> = {
  "jason-lim": {
    ...
    grade: "Senior",
    profile:
      "Student body president, certified EMT, 1530 SAT. A kid who had done everything right.",
  ...
  "sarah-oh": {
    ...
    grade: "Senior",
    profile:
      "Competitive swimmer, 1540 SAT, genuinely excellent writer. Her English teacher called her one of the best students she'd had in years.",
  ...
  "mia-kang": {
    ...
    grade: "Senior",
    profile:
      "Documentary filmmaker, science olympiad competitor, 34 ACT. Funny, self-deprecating, genuinely talented. Didn't think any of it was interesting enough to write about.",
...
export async function generateMetadata({
  ...
  if (!student) return {};
  return {
    title: `${student.name} — Student Story`,
    description: `How ${student.name} found their essay at StoryLab. ${student.outcome}.`,
  };
}

export function generateStaticParams() {
  return Object.keys(students).map((slug) => ({ slug }));
}
    ...
    <div className="bg-transparent">
      <div className="mx-auto w-full max-w-4xl px-6 py-16 sm:py-20">
        ...
        <div className="mt-10 flex items-center gap-5">
          <div
            className={`flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full ${s.color} text-xl font-semibold text-white`}
          >
            {s.initial}
          </div>
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-400">
              {s.grade} &middot; Applying to {s.applying}
            </p>
          </div>
        </div>
        ...
        {/* Profile */}
        <p className="mt-8 text-base leading-relaxed text-zinc-500 italic">
          {s.profile}
        </p>
        ...
        <div className="mt-12 space-y-10">
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-8">
            ...
            <div className="space-y-4">
              {s.problem.paragraphs.map((para, i) => (
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-8">
            ...
            <div className="space-y-4">
              {s.solution.paragraphs.map((para, i) => (
                <p key={i} className="text-base leading-relaxed text-zinc-600">
                  {para}
                </p>
              ))}
        ...
        {/* Pull quote */}
        <figure className="mt-10 rounded-2xl border border-zinc-100 bg-zinc-50 px-8 py-6">
